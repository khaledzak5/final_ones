...
<head>
  ...
  <style>
    ...
    html, body{
      ...
      color:#2b2d31; font-size:13pt; line-height:1.6;
    ...
    * { font-family: inherit !important; }
    ...
    /* ===== البطاقة ===== */
    .card{ background:#fff; border-radius:10px; border:1.2px solid #c5d6de; margin-bottom:12px; }
    .pad{ padding:10px 12px; }
    .chip{
      display:block; text-align:center; padding:2px 10px; margin:0 auto 8px;
      background:#e9f7f9; color:#0f7d89; border:1px solid #c5d6de; border-radius:6px; font-weight:700; font-size:14pt;
    }
    table.meta{ width:100%; border-collapse:collapse; border:1.2px solid #c5d6de; margin-bottom:12px; table-layout:fixed; }
    table.meta th, table.meta td{ border:1.2px solid #c5d6de; padding:6px 8px; text-align:center; font-size:11pt; }
    table.meta td.label{ width:18%; font-weight:700; background:#e9f7f9; color:#0f7d89; }
    ...
    .footer-note{ font-size:9pt; color:#6b7280; margin:0 0 3px 0; }
    .footer-main{ font-size:10.5pt; color:#6b7280; border-top:1px dashed #c5d6de; padding-top:6px; margin:0; }
  </style>
</head>
<body>
